...
INSERT INTO "new_production_cost_config" ("canvasPricePerM2", "cardboardPrice", "createdAt", "crossbarPrice", "framingPrice", "hookPrice", "id", "isActive", "marginPercentage", "printingPricePerM2", "thickStretcherPrice", "thinStretcherPrice", "updatedAt", "wholesaleMarkup") SELECT "canvasPricePerM2", "cardboardPrice", "createdAt", "crossbarPrice", "framingPrice", "hookPrice", "id", "isActive", "marginPercentage", "printingPricePerM2", "thickStretcherPrice", "thinStretcherPrice", "updatedAt", "wholesaleMarkup" FROM "production_cost_config";
